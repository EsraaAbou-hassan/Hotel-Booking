        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    cheapestPrice = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HoteImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HoteImages_Hotels_HotelId",
                        column: x => x.HotelId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookingRoomToUser_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingRoomToUser_UserId1",
                table: "BookingRoomToUser",
                column: "UserId1");

            migrationBuilder.CreateIndex(
                name: "IX_HoteImages_HotelId",
                table: "HoteImages",
                column: "HotelId");
